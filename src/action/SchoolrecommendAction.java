...
public class SchoolrecommendAction extends ActionSupport {
	...
	public String execute() throws Exception {
		try {
			...
			double vpref0, vpref1, vpref2, vpref3, sumeval0 = 0, sumeval1 = 0, sumeval2 = 0, sumeval3 = 0;
			...
			System.out.println(usrCate.trim());
			System.out.println(province.trim());
			List<Object[]> resultlist1 = info.queryforschool(usrCate.trim(),
					province.trim(), "" + difference);
